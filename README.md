...
| --- | --- |
| ![Original Transformer](docs/assets/gallery/transformer-paper-architecture-paper.svg) | ![BERT encoder](docs/assets/gallery/bert-encoder-architecture-paper.svg) |
